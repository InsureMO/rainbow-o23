...
import {ParsedPipelineStepDef, PipelineStepDef} from './types';

export class PipelineStepReader {
	private constructor() {
		// avoid extend
	}

	public static read(def: PipelineStepDef): ParsedPipelineStepDef {
		...
		if (StepBuilderClass == null) {
			...
			return {code, type: 'step', def: new StepBuilderClass(def), ...rest};
		}
	}
}
