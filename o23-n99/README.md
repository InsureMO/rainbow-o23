...
| `AbstractS3PipelineStep`               | `AbstractFragmentaryPipelineStep`  | `o23/n8`  | AWS      | Execute AWS S3 command.                                                     |
...
## AbstractS3PipelineStep, extends AbstractFragmentaryPipelineStep
...
| `bucket`  | `string` | No        | Transaction name. |

### `client`

`string`, cilent name is used to look up the corresponding configuration information when executing the AWS S3 step, as follows:

- `aws.s3.{client}.**`: client configurations.
